...
<head>
    ...
    <!-- Font Awesome Icons -->
    <link rel="stylesheet" href="{{ asset('assets/theme/fontawesome-free/css/all.min.css') }}" />
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Tubes PPL</span>
            </a>
        ...
        <footer class="main-footer text-center">
            ...
            <strong>Copyright &copy; 2021
                <a href="#">/Pariwisata Banyumas</a>.</strong>
            All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <!-- jQuery -->
    <script src="{{ asset('assets/theme/jquery/jquery.min.js') }}"></script>
    <!-- Bootstrap 4 -->
    <script src="{{ asset('assets/theme/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <!-- AdminLTE App -->
